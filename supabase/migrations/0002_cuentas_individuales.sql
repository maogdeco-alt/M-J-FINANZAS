...
-- Perfiles — uno por cada auth.users
...
-- Espacios — 'personal' (uno por usuario, privado) o 'casa' (compartido).
...
-- Códigos para crear una Casa entre dos personas.
...
-- El estado completo de cada espacio
